	...
	\begin{frame}
		...
		\begin{table}
			\begin{tabularx}{.9\textwidth}{ |*{2}{X|} }
				...
				\multicolumn{2}{|>{\hsize=\dimexpr2\hsize+2\tabcolsep+\arrayrulewidth\relax}X|}{\textit{Descrizione}: \scriptsize Interfaccia per modellare gerico creditore o debitore, sia esso individuo o gruppo}\\\hline
			\end{tabularx}
		\end{table}
